  ...
  instance
    ...
    .post(
      "/login",
      {
        schema: {
          summary: "로그인",
          description: `JWT 액세스 토큰과 리프레시 토큰을 생성합니다. 리프레시 토큰은 쿠키에 들어가요. 리프레시 토큰과 액세스 토큰은 각각 ${
            REFRESH_TOKEN_EXPIRATION / 1000 / 60
          }, ${ACCESS_TOKEN_EXPIRATION / 1000 / 60}분 후에 만료됩니다`,
          body: Type.Object({
